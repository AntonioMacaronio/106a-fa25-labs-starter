...
class UR7e_CubeGrasp(Node):
    def __init__(self):
        ...
        self.cube_sub = self.create_subscription(PointStamped, '/transformed_cube_pose', self.cube_callback, 1) # TODO: CHECK IF TOPIC ALIGNS WITH YOURS
    ...
    def cube_callback(self, cube_pose):
        ...
        '''
        self.job_queue.append(self.ik_planner.compute_ik(self.joint_state, cube_pose.x, cube_pose.y - 0.035, cube_pose.z + 0.185))
        ...
        '''
        self.job_queue.append(self.ik_planner.compute_ik(self.joint_state, cube_pose.x, cube_pose.y - 0.035, cube_pose.z + 0.16))
        ...
        '''
        self.job_queue.append(self.ik_planner.compute_ik(self.joint_state, cube_pose.x + 0.4, cube_pose.y - 0.035, cube_pose.z + 0.185))
